...
class Article(models.Model):
    ...
    head_img = models.ImageField(u'文章标题图片',upload_to="image",blank=True,null=True)
...
class Comment(models.Model):
    article = models.ForeignKey(Article,verbose_name=u"搜索文章")
    parent_comment = models.ForeignKey('self',related_name='my_children',blank=True,null=True)
    comm_choices = ((1,u"评论"),
                    (2,u"点赞"),
                    )
    comment_type =models.IntegerField(choices=comm_choices,default=1)
